classdef spectra_Class < handle
    ...
    properties
        ...
        saving = 0;             %Boolean tracking if the current spectra should be saved. 
    ...
    methods
        ...
        function saveHelp(app)
            
            app.saved_Spectra = [app.saved_Spectra transpose(app.spectrum)];
            ...
            fileID = fopen(app.filename, 'wt');
            fprintf(fileID, header);
            fprintf(fileID, '%s', names);
            fclose(fileID);
            
            for k = 1:app.num_Saved
                dlmwrite(app.filename, data(:, k), '-append', 'delimiter', ' ')
            end
        end
